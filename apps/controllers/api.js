...
var data_tables = {
    users: 'mryu_users',
    webs_site_value: 'webs_site_value',
    currencies: 'mryu_currencies'
}
...
router.post("/add-user", jsonParser, (req, res) => {
    if (req.body) {
        ...
        db_model.addData(data_tables.users, fields)
...
router.get("/get-site-values", (req, res) => {
    var db = data_tables.webs_site_value;
    var fields = '*';
    var where = req.query.where;
    var orderBy = '';
    db_model.getData(db, fields, where, orderBy)
